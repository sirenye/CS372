...
class IcmpHelperLibrary:
    ...
    def __sendIcmpTraceRoute(self, host):
        ...
        ### << Construct and send packets with increasing ttl starting from 1>> ###
        ### << Stop either when the the returned ip address is the same as the the destination address or
        ### the ttl number exceeds the maximum hop number (we can set the number to 30 by default) >> ###
...
def main():
    ...
    icmpHelperPing.sendPing("223.6.6.6")
